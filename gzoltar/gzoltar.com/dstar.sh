...
SPECTRA_FILE="$OUTPUT_DIR/dstar/sfl/txt/spectra.csv"
MATRIX_FILE="$OUTPUT_DIR/dstar/sfl/txt/matrix.txt"
TESTS_FILE="$OUTPUT_DIR/dstar/sfl/txt/tests.csv"
...
java -cp $BUILD_DIR:$JUNIT_JAR:$HAMCREST_JAR:$GZOLTAR_CLI_JAR \
  com.gzoltar.cli.Main faultLocalizationReport \
    ...
    --dataFile "$SER_FILE" \
    --outputDirectory "$OUTPUT_DIR/dstar" \
    --family "sfl" \
    --formula "dstar" \
    --metric "entropy" \
